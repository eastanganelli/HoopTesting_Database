...
CREATE
DEFINER = 'root'@'%'
PROCEDURE IF NOT EXISTS selectSampleID (IN standard varchar(25), IN material varchar(10), IN specification varchar(6), IN diamnom int UNSIGNED, IN diamreal int UNSIGNED, IN wallthick int UNSIGNED, IN lenfree int UNSIGNED, IN lentotal int UNSIGNED)
DETERMINISTIC
BEGIN
...
CREATE
DEFINER = 'root'@'%'
PROCEDURE IF NOT EXISTS insertSample (IN standard varchar(25), IN material varchar(10), IN specification varchar(6), IN diamnom int UNSIGNED, IN diamreal int UNSIGNED, IN wallthick int UNSIGNED, IN lenfree int UNSIGNED, IN lentotal int UNSIGNED, IN condPeriod varchar(15))
DETERMINISTIC
BEGIN
...
CREATE
DEFINER = 'root'@'%'
PROCEDURE IF NOT EXISTS insertSpecimen (IN idSample int UNSIGNED, IN targetPressureIn int, IN targetTempIn int, IN operatorName varchar(40), IN enviromentIn varchar(20), IN testNameIn varchar(120), IN endCapIn varchar(10))
BEGIN
...
GRANT EXECUTE ON PROCEDURE data_db.countspecimens TO 'databaseManager'@'%';
GRANT EXECUTE ON PROCEDURE data_db.insertdata TO 'databaseManager'@'%';
GRANT EXECUTE ON PROCEDURE data_db.insertsample TO 'databaseManager'@'%';
GRANT EXECUTE ON PROCEDURE data_db.insertspecimen TO 'databaseManager'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selectsample TO 'databaseManager'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selectsampleid TO 'databaseManager'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selectspecimen TO 'databaseManager'@'%';
