...
-- Script date 29/5/2024 22:39:19
...
BEGIN
  ...
  IF (selected = 0) THEN
    ...
    SELECT
      JSON_OBJECT('key', sc.id,
      'time', sc.name,
      'timeType', sc.timeType,
...
(0, 'PE', 'Plastico E', '2023-12-15 12:45:36', '2024-05-29 22:23:34'),
(1, 'PBC', 'Plastico BC', '2023-12-20 12:57:44', '2024-05-29 22:23:44');
...
(19, 40116590, 'Noelia Agustina', 'Di Mario', '2024-05-29 15:14:53.1109', '2024-05-29 15:30:56.7361'),
(20, 56400346, 'Felipe', 'Daffunchio', '2024-05-29 20:27:42.1353', '2024-05-29 20:27:42.1353');
