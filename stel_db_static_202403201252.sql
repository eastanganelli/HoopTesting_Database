...
-- Script date 20/3/2024 12:52:36
...
--
ALTER TABLE standard_has_enviroments
ADD CONSTRAINT FK_standard_has_enviroments_enviroment_id FOREIGN KEY (idEnviroment)
...
--
ALTER TABLE standard_has_enviroments
ADD CONSTRAINT FK_standard_has_enviroments_standard_id FOREIGN KEY (idStandard)
...
--
-- Create table `endcap_has_standard`
--
CREATE TABLE IF NOT EXISTS endcap_has_standard (
  id int UNSIGNED NOT NULL,
  standard int UNSIGNED NOT NULL,
...
-- Create foreign key
--
ALTER TABLE endcap_has_standard
...
(0, 1, 0, 3, '1 h Ã‚Â± 5 m', '2023-12-04 21:48:36', '2024-01-08 23:29:36'),
(1, 1, 3, 8, '3 h Ã‚Â± 15 ', '2023-12-04 21:49:27', '2024-01-08 23:29:36'),
(2, 1, 8, 16, '6 h Ã‚Â± 30 ', '2023-12-04 21:56:39', '2024-01-08 23:29:36'),
(3, 1, 16, 32, '10 h Ã‚Â± 1 ', '2023-12-04 21:56:39', '2024-01-08 23:29:36'),
(4, 1, 32, 9999999, '16 h Ã‚Â± 1 ', '2023-12-04 21:56:39', '2024-01-08 23:29:36');
...
-- Table stel_db_static.endcap_has_standard does not contain any data (it is empty)
