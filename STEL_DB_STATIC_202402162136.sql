...
-- Script date 16/2/2024 21:36:16
...
CREATE USER IF NOT EXISTS 'mysql.session'@'localhost' IDENTIFIED WITH mysql_native_password PASSWORD EXPIRE DEFAULT ACCOUNT LOCK;
GRANT SUPER ON *.* TO 'mysql.session'@'localhost';
GRANT SELECT ON performance_schema.* TO 'mysql.session'@'localhost';



CREATE USER IF NOT EXISTS 'mysql.sys'@'localhost' IDENTIFIED WITH mysql_native_password PASSWORD EXPIRE DEFAULT ACCOUNT LOCK;
...
CREATE USER IF NOT EXISTS 'root'@'%' IDENTIFIED WITH mysql_native_password PASSWORD EXPIRE DEFAULT;
...
-- 
-- Dumping data for table standard_has_endcap
--
