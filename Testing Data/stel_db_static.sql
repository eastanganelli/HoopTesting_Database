...
CREATE
DEFINER = 'root'@'localhost'
PROCEDURE IF NOT EXISTS insertEnviroment (IN idStandard int UNSIGNED, IN insertFluid varbinary(15), IN outFluid varbinary(15))
DETERMINISTIC
BEGIN
...
--
INSERT INTO enviroment(id, standard, insertFluid, outFluid, createdAt, updatedAt) VALUES
