...
-- Script date 28/8/2024 21:57:21
...
--
-- Create function `selectSettings_Specification_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectSettings_Specification_Into_JSON (idSpecification int UNSIGNED)
RETURNS json
DETERMINISTIC
BEGIN
...
--
-- Create function `selectSpecifications_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectSpecifications_Into_JSON (idMaterial int UNSIGNED)
RETURNS json
DETERMINISTIC
BEGIN
  ...
  IF (elements > 0) THEN
    SELECT
      ...
      'configurations', (selectSettings_Specification_Into_JSON(s.id)))) INTO result
    FROM specification s
    WHERE s.material = idMaterial;
  ELSE
    SELECT
...
BEGIN
  ...
  SELECT
    ...
    'specifications', (selectSpecifications_Into_JSON(m.id)))) AS `materials`
  FROM material m;
...
--
-- Create function `selectOperators_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectOperators_Into_JSON ()
RETURNS json
DETERMINISTIC
BEGIN
  ...
  SELECT
    ...
    'dni', o.dni,
    'name', o.name,
    'familyName', o.familyname)) AS `operators` INTO result
  FROM operator o;
...
--
-- Create function `selectTest_Type_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectTest_Type_Into_JSON (idStandard int UNSIGNED)
RETURNS json
DETERMINISTIC
BEGIN
...
--
-- Create function `selectMaterials_has_Standard_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectMaterials_has_Standard_Into_JSON (idStandard int UNSIGNED)
RETURNS json
DETERMINISTIC
BEGIN
  ...
  IF (elements > 0) THEN
    SELECT
      ...
      'specifications', selectSpecifications_Into_JSON(m.id))) INTO result
    FROM material_has_standard mhs
...
--
-- Create function `selectEnviroments_has_Standard_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectEnviroments_has_Standard_Into_JSON (idStandard int UNSIGNED)
RETURNS json
DETERMINISTIC
BEGIN
...
--
-- Create function `selectEndCaps_has_Standard_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectEndCaps_has_Standard_Into_JSON (idStandard int UNSIGNED)
RETURNS json
DETERMINISTIC
BEGIN
...
--
-- Create function `selectConditional_Periods_has_Standard_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectConditional_Periods_has_Standard_Into_JSON (idStandard int UNSIGNED)
RETURNS json
DETERMINISTIC
...
--
-- Create function `selectStandard_Into_JSON`
--
CREATE
DEFINER = 'root'@'localhost'
FUNCTION IF NOT EXISTS selectStandard_Into_JSON ()
RETURNS json
DETERMINISTIC
BEGIN
  ...
  SELECT
    JSON_ARRAYAGG(JSON_OBJECT('id', s.id,
    'standard', s.name,
    'endcaps', (SELECT
        selectEndCaps_has_Standard_Into_JSON(s.id)),
    'enviroments', (SELECT
        selectEnviroments_has_Standard_Into_JSON(s.id)),
    'testtypes', (SELECT
        selectTest_Type_Into_JSON(s.id)),
    'conditionalperiods', (SELECT
        selectConditional_Periods_has_Standard_Into_JSON(s.id)),
    'materials', (SELECT
        selectMaterials_has_Standard_Into_JSON(s.id)))) AS StandardsJSON INTO result
  FROM standard s;
...
BEGIN
  ...
  SELECT
    JSON_ARRAYAGG(JSON_OBJECT('key', s.id,
    'standard', s.name,
    'materials', (selectMaterials_has_Standard_Into_JSON(s.id)),
    'enviroments', (selectEnviroments_has_Standard_Into_JSON(s.id)),
    'endCaps', (selectEndCaps_has_Standard_Into_JSON(s.id)),
    'conditionalPeriods', (selectConditional_Periods_has_Standard_Into_JSON(s.id)),
    'testTypes', (selectTest_Type_Into_JSON(s.id)))) AS `standards`
  FROM standard s;
