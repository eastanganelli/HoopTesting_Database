...
-- Script date 12/6/2024 18:19:31
...
CREATE
DEFINER = 'root'@'localhost'
PROCEDURE IF NOT EXISTS insertTestType (IN idStandard int UNSIGNED, IN tesTypeIN varbinary(255))
DETERMINISTIC
BEGIN
...
CREATE
DEFINER = 'root'@'localhost'
PROCEDURE IF NOT EXISTS insertEnviroment (IN idStandard int UNSIGNED, IN insideFluid varchar(30), IN outsideFluid varchar(30))
DETERMINISTIC
BEGIN
...
CREATE
DEFINER = 'root'@'localhost'
PROCEDURE IF NOT EXISTS insertConditionalPeriod (IN idStandard int UNSIGNED, IN minwall int, IN maxwall int, IN time varchar(20))
DETERMINISTIC
BEGIN
...
CREATE USER IF NOT EXISTS 'dataCollector'@'%' IDENTIFIED WITH mysql_native_password PASSWORD EXPIRE NEVER;
...
GRANT EXECUTE ON PROCEDURE data_db.countspecimens TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.deletetest TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.getspecimendata TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selectcomparetests TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selectsample TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selectsampleid TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selectspecimen TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selecttest TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selecttestdata TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.selecttests TO 'reporting'@'%';
GRANT EXECUTE ON PROCEDURE data_db.updatespecimen TO 'reporting'@'%';
...
--
INSERT INTO material(id, name, description, createdAt, updatedAt) VALUES
...
--
INSERT INTO specification(id, material, name, description, createdAt, updatedAt) VALUES
...
--
INSERT INTO standard(id, name, createdAt, updatedAt) VALUES
...
--
INSERT INTO test_type(id, standard, testType, createdAt, updatedAt) VALUES
...
--
INSERT INTO specification_configuration(id, specification, time, timeType, temperature, createdAt, updatedAt) VALUES
...
--
INSERT INTO operator(id, dni, name, familyname, createdAt, updatedAt) VALUES
...
--
INSERT INTO material_has_standard(id, material, standard, type, createdAt, updatedAt) VALUES
...
--
INSERT INTO enviroment(id, standard, inside, outside, createdAt, updatedAt) VALUES
...
--
INSERT INTO endcap(id, standard, name, createdAt, updatedAt) VALUES
...
--
INSERT INTO conditional_period(id, standard, time, minwall, maxwall, createdAt, updatedtAt) VALUES
